...
namespace Domain.Interfaces.Repositories
{
    public interface ICategoriaRepository
    {
        ...
        Task<Categoria> UpdateAsync(Categoria categoria, CancellationToken cancellationToken = default);
        ...
        IQueryable<Categoria> GetAllAsync(string? search = null, CancellationToken cancellationToken = default);
    }
}
